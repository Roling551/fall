    ...
    list = new Map<string, ()=>CharacterCardInfo>([
        [
            ...
            ()=>this.characterCardFactory.createCharacterCard({
                name: "RECYCLER",
                skills: new Map([["engineering", 3], ["construction", 1]]),
                characterAction: {
        ...
        [
            ...
            ()=>this.characterCardFactory.createCharacterCard({
                name: "DEMOLISHER",
                skills: new Map([["mining", 1], ["construction", 3]]),
                characterAction: {
                    name: "demolishEstate",
                    refundFraction: 0.5,
                    repeatNumber: 2,
        ...
        [
            ...
            ()=>this.characterCardFactory.createCharacterCard({
                name: "ACCOUNTANT",
                skills: new Map([["engineering", 1], ["construction", 1]],),
                characterAction: {
                    name: "getReward",
        ...
        [
            ...
            ()=>this.characterCardFactory.createCharacterCard({
                name: "MINER",
                skills: new Map([["engineering", 1], ["mining", 3]],),
                characterAction: {
                    name: "getReward",
